...
class GovNotifyFailureClassifierTest {
    ...
    @Test
    void treats_bad_request_and_too_large_as_permanent() {
    ...
    @Test
    void treats_server_and_other_http_errors_as_temporary() {
        ...
        assertThat(GovNotifyFailureClassifier.isTemporary(404, "not found")).isTrue();
    }
